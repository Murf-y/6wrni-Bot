...
check_spam_channels = [798227310779957258, 798227617659486233, 773935539316326411, 760140536199380993,752578125644300449,675750032909008947,736310812787998732,675751520595214337]
# ----------------------------------- CHANNELS--------------------------------------------------
...
rules = {1:"يمنع إستخدام الألفاظ النابية أو البذيئة أو التهجم على الأعضاء",
         ...
         0:"المرجوا عدم عمل منشن عشواءيا للاعضاء"}
